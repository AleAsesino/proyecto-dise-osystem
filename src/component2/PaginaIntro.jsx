...
const PaginaIntro = ({ setopen,setcaja}) => {
  useEffect(() => {
          ...
          <div className='w-full  flex-col '>
            <div className='  flex place-content-center'>
              <span className=' text-[#fff] font-serif w-[40%] p-10'>
                <h1 className='text-[34px] pl-5'>Inicio</h1>
                <hr className=' border-gray-50 pt-5 w-full'></hr>
                <h1 className='text-[24px] pl-14 pb-4'>Introducción</h1>
                <h1 className='text-[24px] pl-14 pb-4'>Antecedentes</h1>
              </span>
              <span className=' text-[#fff] font-serif w-[40%] p-10'>
