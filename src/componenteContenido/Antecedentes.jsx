  ...
  return (
    <div className='w-full bg-[#0A192E] flex pb-40 place-content-center'>
        <div className='  w-[40%]'>
            ...
            <h1 className='text-white text-[32px] pl-2'>Causas </h1>
            <h1 className='text-[#B1BACC] text-[20px] p-5 bg-[#172945] mb-14'>
            ...
            <div className='flex relative w-[100%] my-20'>
              ...
              <div className="absolute  w-[100%]">
                <div className='pl-[42%] '>
                  <h1 className=' text-white text-[32px] text-end '>Historia del supermercado</h1>
                  <h1 className='  text-[#B1BACC] text-[20px] bg-[#172945] p-5 '>El primer supermercado nacio en EEUU, en 1916 con el nombre de Piggly Wiggly en Memphis, Tennessee</h1>
                </div>
              </div>
            </div>
